...
/**
 * Inspired by https://github.com/Shopify/eslint-plugin-shopify/blob/master/lib/rules/prefer-class-properties.js
 */
...
module.exports = {
  ...
  create(context) {
    ...
    function checkClassDeclaration(node) {
      if (applyAlways) {
        const c = getConstructor(node);
        if (!c) return;

        getTopLevelThisAssignmentExpressions(c.value).forEach(
